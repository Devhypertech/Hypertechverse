            ...
            <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                ...
                <ScrollAnimation animation="fadeInUp" delay={200}>
                    <div className="text-center mb-10 md:mb-14">
                        <h2 className="text-[40px] leading-[1.05] font-black tracking-tighter text-[#1D1D1D] md:text-6xl lg:text-7xl" style={{ fontFamily: "'Recent Grotesk', 'Recursive', sans-serif", fontWeight: 900 }}>
                            Smart Solutions
                            <br />
                            <span className="inline-block mt-1">that Drive Success</span>
                        </h2>

                        <p className="mt-4 text-[16px] md:text-[18px] font-black tracking-tighter capitalize text-[#1D1D1D] max-w-3xl mx-auto" style={{ fontFamily: "'Recent Grotesk', 'Recursive', sans-serif", fontWeight: 900 }}>
                ...
                <ScrollAnimation animation="fadeInUp" delay={400}>
                    <div className="relative px-0 sm:px-24">
                        {/* Left arrow */}
                        <button
                            aria-label="Previous"
                        ...
                        <div
                            ref={trackRef}
                            className="flex gap-4 sm:gap-6 overflow-x-auto scroll-smooth snap-x snap-mandatory pb-2 px-12 sm:px-0 [-ms-overflow-style:none] [scrollbar-width:none]"
                        >
                            {cards.map((c, i) => (
