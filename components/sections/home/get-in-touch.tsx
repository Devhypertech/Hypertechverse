        ...
        <section className="bg-black py-20 relative overflow-hidden">
            ...
            <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 relative z-10">
                <div className="flex flex-col items-center text-center">
                    {/* Phone visual */}
                    <div className="mb-8 animate-fade-in-up hover-scale">
                        <Image
                            src="/telephone.png"
                            alt="Orange retro rotary phone"
                            width={800}
                            height={600}
                            className="h-100 w-auto object-contain animate-float hover-glow"
                        />
                    </div>

                    {/* Content */}
                    <div className="space-y-4">
                        <h2 className="text-5xl font-extrabold text-pink-200 font-recent-grotesk animate-fade-in-up stagger-1 text-shimmer">
                            Get in touch
                        </h2>
                        <p className="text-lg text-pink-300 animate-fade-in-up stagger-2">
                            I&apos;ll get back to you within 24 hrs
                        </p>
                        <div className="pt-4 animate-fade-in-up stagger-3">
                            <Link
                                href="/contact"
                                className="inline-block bg-white text-black px-8 py-4 rounded-lg hover:bg-gray-100 transition-all duration-300 font-semibold hover-scale hover-lift hover-shake gradient-animate"
                            >
                                Get started
                            </Link>
                        </div>
