                            ...
                            <ScrollAnimation key={index} animation="fadeInUp" delay={600 + (index * 100)}>
                                <div className="rounded-2xl overflow-visible">
                                    ...
                                    <div className="pt-4">
                                        ...
                                        <h3 className="mt-1 text-md font-semibold text-[#fff9f1] uppercase" style={{ fontFamily: "'Inter','Recent Grotesk', sans-serif", fontWeight: 800, color: '#EA7BBF' }}>{project.title}</h3>
